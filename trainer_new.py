...
class Trainer(object):
    ...
    def __init__(self, 
        ...
        # NOTE: self.method = 'reinforcement'
        ...
        self.throw_rewards = throw_rewards
...
"""
    ...
    def backprop(self, color_heightmap, depth_heightmap, primitive_action, best_pix_ind, label_value):
        ...
        loss_value = 0
        if primitive_action == 'throw':

            # Do forward pass with specified rotation (to save gradients)
            throw_predictions, grasp_predictions, state_feat = self.forward(color_heightmap, depth_heightmap, is_volatile=False, specific_rotation=best_pix_ind[0])
